...
public class BuyerController {
    ...
    public ResponseEntity<Map<String,String>> createAccount(@Validated @RequestBody BuyerViewModel buyerViewModel, BindingResult bindingResult)
    {
        ...
        Account account=new Account(buyerViewModel.getPassword(),buyerViewModel.getUsername(), List.of(new Buyer(buyerViewModel.getOrganizationName(),buyerViewModel.getRepresentativeFullName(),new Date(),null,null,"buyer",null)));
